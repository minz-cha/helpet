...
import com.helpet.databinding.FragmentCatPetBinding
import retrofit2.Call
import retrofit2.Response


class CatPet : Fragment() {
    private lateinit var binding: FragmentCatPetBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentCatPetBinding.inflate(layoutInflater)
        ...
        server3.getPetRegister(value).enqueue(object : retrofit2.Callback<petListResponseDTO> {
            ...
            override fun onResponse(call: Call<petListResponseDTO>, response: Response<petListResponseDTO>) {
                ...
                val filteredResult = mutableListOf<Result>()
                ...
                // 어댑터 생성 및 연결
                val adapter = CatAdapter(filteredResult)
