...
import com.helpet.R
import com.helpet.databinding.FragmentDogPetBinding
import com.helpet.databinding.FragmentTotalPetBinding
import retrofit2.Call
import retrofit2.Response

class DogPet : Fragment() {

    private lateinit var binding: FragmentDogPetBinding
    val gson = Gson()
    val bundle = Bundle()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentDogPetBinding.inflate(layoutInflater)
        ...
        server3.getPetRegister(value).enqueue(object : retrofit2.Callback<petListResponseDTO> {
            ...
            override fun onResponse(call: Call<petListResponseDTO>, response: Response<petListResponseDTO>) {
                ...
                // 어댑터 생성 및 연결
                val adapter = DogAdapter(filteredResult)
