...
class DBHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    companion object {
        ...
        private const val TABLE_DISEASES = "disease"
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        // 초기 데이터 삽입
        insertDisease(db, "결막염", "강아지", "결막염에 걸리면 눈꺼풀 주위가 아프거나 가려워진다.\n개는 이에 앞발로 눈을 비비거나 바닥에 얼굴을 문지르는 등의 행동을 보인다.\n눈물이 많이 나기도 하며 눈곱이 많이 낄 수 있다.", "크게 세 가지로,\n1) 눈을 세게 문지르거나, 눈에 털이 들어가는 등의물리 & 샴푸나 약품 등의 화학적 자극\n2) 세균 또는 바이러스 감염\n3) 알레르겐(알레르기 원인 물질)이 눈에 직접 닿았거나, 코로 흡입, 입으로 섭취했을 경우 알레르기 반응이 원인이 된다.", "물리·화학적 원인의 결막염을 예방하려면 눈썹 등 눈 부위의 털 관리를 세심히 하며, 샴푸가 눈 부위에 닿지 않도록 유의한다.\n감염성 결막염을 예방하려면 청결한 몸 상태를 유지하고, 반려견이 지내는 집안 환경 역시 깔끔하게 자주 청소해준다.\n알레르기성 결막염 예방을 위해서는 반려견의 알레르겐이 무엇인지를 미리 알아두고, 가급적 정해진 식사만 하도록 한다.")
